  ...
  <div className="w-full py-20 lg:py-40 relative">
    ...
    <div className="container mx-auto flex flex-col gap-14 px-4 sm:px-6 lg:px-8">
      <div className="flex w-full flex-col sm:flex-row sm:justify-between sm:items-center gap-8">
        <h4 className="text-3xl md:text-5xl tracking-tighter max-w-xl font-regular text-gray-900">
          Latest articles
        </h4>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {blogPosts.map((post, index) => (
          <div key={index} className="flex flex-col gap-2 hover:opacity-90 cursor-pointer transition-all duration-300 group">
            ...
            <h3 className="text-xl tracking-tight text-gray-900 group-hover:text-purple-600 transition-colors">
              {post.title}
            </h3>
